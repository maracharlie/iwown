...
$form['callback-form'] = array(
	...
	'cfg' => array(
		...
		'from_name' => 'noreply',
		'to_email' => 'a.bastrichkin@yandex.ru',
		'to_name' => 'manager',
		'geoip' => true,
		'referer' => true,
		'type' => 'plain',
		...
		'okay' => 'В ближайшее время с Вами<br> свяжется наш менеджер',
		'fuck' => 'Сообщение не отправлено - попробуйте еще раз',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal',
		'usepresuf' => false
	)
...
$form['q50-form'] = array(
	...
	'cfg' => array(
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => 'Мы приняли Ваш заказ. В ближайшее время с Вами<br> свяжется наш менеджер',
		'fuck' => 'Сообщение не отправлено - попробуйте еще раз',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal',
		'usepresuf' => false
